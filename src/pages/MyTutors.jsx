...
const MyTutorials = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      ...
      <h2 className="text-5xl font-extrabold text-center text-gray-900 dark:text-gray-100 mb-14 tracking-tight">
        My Tutorials
      </h2>

      {tutorials.length > 0 ? (
        <div className="overflow-x-auto rounded-3xl shadow-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900">
        ...
        <div className="flex flex-col items-center justify-center text-center mt-24 px-4">
          <img
            ...
            loading="lazy"
          />
          <h3 className="text-3xl font-semibold text-gray-700 dark:text-gray-300 mb-3">
            No tutorials found
          </h3>
          ...
          <button
            ...
            className="bg-indigo-700 hover:bg-indigo-800 text-white px-8 py-3 rounded-2xl shadow-lg hover:shadow-xl transition"
