...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-24 px-6 bg-gradient-to-br from-white via-blue-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-500">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {features.map(({ Icon, title, color, description }, i) => (
            <div
              key={i}
              className="group relative rounded-3xl p-10 bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-gray-200 dark:border-gray-700 shadow-lg 
                         hover:shadow-3xl hover:scale-105 hover:-translate-y-2 transition-transform duration-500 ease-in-out cursor-pointer"
            >
              <Icon
