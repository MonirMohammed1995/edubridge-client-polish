...
const LanguageCategory = () => {
  ...
  return (
    <section className="py-24 px-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-950 dark:to-gray-900 transition-colors duration-500">
      <div className="max-w-7xl mx-auto">
        {/* Heading */}
        <h2 className="text-5xl md:text-6xl font-extrabold mb-4 text-center text-gray-900 dark:text-gray-100 tracking-tight leading-tight">
          Explore <span className="text-blue-700 dark:text-blue-400">Language</span> Categories
        </h2>
        <p className="mb-16 max-w-3xl mx-auto text-center text-lg md:text-xl text-gray-600 dark:text-gray-300">
          ...
          {categories.map((cat, idx) => (
            ...
            >
              <div className="flex items-center gap-5 mb-6">
                ...
                <h3 className="text-2xl md:text-3xl font-semibold text-gray-900 dark:text-gray-100 group-hover:text-blue-700 dark:group-hover:text-blue-400 transition-colors">
                  {cat.title}
                </h3>
              </div>

              <div className="flex items-center justify-between text-gray-600 dark:text-gray-300 text-sm md:text-base font-medium">
                <span className="select-none">
                  Discover {cat.title} tutors
                </span>
                <FaArrowRight
                  className="text-blue-600 dark:text-blue-400 group-hover:translate-x-2 transition-transform duration-300"
                  aria-hidden="true"
                />
              </div>
